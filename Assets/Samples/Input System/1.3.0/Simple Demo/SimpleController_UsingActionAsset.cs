...
public class SimpleController_UsingActionAsset : MonoBehaviour
{
    ...
    [Tooltip("Test Purpose")]
    [SerializeField] Vector2 mousePoint;
    ...
    private void Look(Vector2 rotate)
    {
        ...
        //m_Rotation.x = Mathf.Clamp(m_Rotation.x - rotate.y * scaledRotateSpeed, -90, 90);
        m_Rotation.x = m_Rotation.x - rotate.y * scaledRotateSpeed;
        if(m_Rotation.x > 90 || m_Rotation.x < -90)
        {
            transform.localEulerAngles = MainTools.V3SetZ(transform.localEulerAngles, 180);
            //m_Rotation = MainTools.V3SetY(m_Rotation, -m_Rotation.y);
        }
